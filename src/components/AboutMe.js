    ...
    <div className="w-10/12 container mx-auto mt-9">
      ...
      <div className="info flex flex-col-reverse sm:grid sm:grid-cols-2">
        <div className="info-text sm:span-col-8 lg:mt-5">
          ...
          <br />
          <p>
            I've graduated from Savitribai Phule Pune University with degree in
            IT Engineering. I always had fond of learning new skills and
          ...
          <br />
          <p>
            When I am not coding, I like to play chess, guitar, read books, edit
